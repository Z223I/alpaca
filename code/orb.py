...
class ORB:
    ...
    def _get_orb_market_data(self) -> bool:
        """
        Get market data for symbols from CSV for normal market hours (9:30 AM to 4:00 PM ET).
        ...
        try:
            ...
            # Use date from CSV filename with normal market hours (9:30 AM to 4:00 PM ET)
