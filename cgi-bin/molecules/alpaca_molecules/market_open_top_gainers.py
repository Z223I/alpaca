...
"""
Usage:
python cgi-bin/molecules/alpaca_molecules/market_open_top_gainers.py  --exchanges NASDAQ AMEX  --max-symbols 7000  --min-price 0.75  --max-price 40.00  --min-volume 50000 --top-gainers 20 --export-csv gainers_nasdaq_amex.csv --verbose
"""
...
# This file is at: cgi-bin/molecules/alpaca_molecules/market_open_top_gainers.py
